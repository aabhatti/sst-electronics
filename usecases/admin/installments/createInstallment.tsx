...
interface IInstallmentBoy extends Omit<IInstallment, "createdB updatedBy"> {}
...
async function createInstallment(
  ...
  console.log("createInstallment>", createInstallment);
  ...
  if (deal && installment) {
    ...
    console.log("deal after installment>>", deal);
  }
